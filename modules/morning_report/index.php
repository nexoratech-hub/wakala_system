<?php
// ================================================================
// FILE: C:\xampp\htdocs\wakala_system\modules\morning_report\index.php
// WAKALA FINANCIAL SYSTEM - MORNING REPORT DASHBOARD
// ================================================================
...
$has_report = ($today_report !== false);

// --- Get Evening Stock for comparison ---
$stmt = $db->prepare("SELECT cumm_total FROM evening_stocks 
                      WHERE employee_id = ? AND stock_date = ?");
$stmt->execute([$employee_id, $today]);
$evening = $stmt->fetch();
$evening_total = $evening['cumm_total'] ?? 0;

$morning_total = $today_report['cumm_total'] ?? 0;
...
<head>
    ...
    <title>Morning Report Dashboard - Wakala</title>
...
<body>
    ...
    <nav class="admin-sidebar" id="adminSidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="#" class="active"><i class="fas fa-sun"></i> Morning Report</a></li>
    ...
    <div class="main-wrapper">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div>
                    <h1>
                        <i class="fas fa-sun" style="color:#DC2626;"></i> Morning Report
                        <small>Manage morning float and cash balances</small>
                    </h1>
                </div>
                <div class="header-actions">
                    <a href="add.php" class="btn btn-primary">
                        <i class="fas fa-plus"></i> Add Morning Report
                    </a>
            ...
            <div class="stats-row">
                <div class="stat-card border-red">
                    ...
                    <div class="stat-value"><?php echo $has_report ? formatCurrency($morning_total) : 'No Data'; ?></div>
                    <div class="stat-sub"><?php echo $has_report ? 'Submitted: ' . date('h:i A', strtotime($today_report['submitted_at'])) : 'Not submitted yet'; ?></div>
                </div>
                
                <div class="stat-card <?php echo $has_report ? 'border-green' : 'border-orange'; ?>">
                    ...
                    <div class="stat-value <?php echo $difference > 0 ? 'positive' : ($difference < 0 ? 'negative' : ''); ?>">
                        <?php 
                        if ($has_report) {
                            echo ($difference >= 0 ? '+' : '') . formatCurrency($difference);
                        } else {
                ...
                <div class="stat-card border-blue">
                    ...
                    <div class="stat-sub"><?php echo $stats['total'] ?? 0; ?> reports</div>
                </div>
                ...
                <div class="stat-card border-orange">
                    ...
                    <div class="stat-value" style="font-size:16px;">
                        <?php 
                        $last = $recent_reports[0] ?? null;
                        echo $last ? date('d M Y', strtotime($last['report_date'])) : 'No records';
                        ?>
                    </div>
            ...
            <div class="today-card">
                <div class="today-header">
                    <h3>
                        ...
                        Today's Morning Report - <?php echo date('d M Y'); ?>
                    </h3>
                ...
                <div class="today-details">
                    <div class="detail-item">
                        ...
                        <div class="value"><?php echo $today_report['report_number']; ?></div>
                    </div>
                    <div class="detail-item">
                        <div class="label">Total Amount</div>
                        <div class="value"><?php echo formatCurrency($today_report['cumm_total']); ?></div>
                    </div>
                    <div class="detail-item">
                        <div class="label">Cash Balance</div>
                        <div class="value"><?php echo formatCurrency($today_report['cash_balance']); ?></div>
                    </div>
                    <div class="detail-item">
                        <div class="label">Submitted At</div>
                        <div class="value" style="font-size:14px;"><?php echo date('h:i A', strtotime($today_report['submitted_at'])); ?></div>
                    </div>
                    <div class="detail-item">
                        <div class="label">Evening Total</div>
                        <div class="value"><?php echo formatCurrency($evening_total); ?></div>
                    </div>
                    <div class="detail-item">
                ...
                <div style="margin-top:12px; display:flex; gap:10px; flex-wrap:wrap;">
                    <a href="view.php?id=<?php echo $today_report['id']; ?>" class="btn btn-secondary btn-sm">
                        <i class="fas fa-eye"></i> View Details
                    </a>
                    <a href="edit.php?id=<?php echo $today_report['id']; ?>" class="btn btn-primary btn-sm">
            ...
            <div class="alert alert-warning">
                ...
                <span><strong>No morning report submitted today.</strong> Please add morning report for <?php echo date('d M Y'); ?>.</span>
            ...
            <div class="table-container">
                <div class="table-header">
                    <h3><i class="fas fa-history" style="color:#DC2626;"></i> Recent Morning Reports</h3>
                ...
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="font-weight:600;"><?php echo $report['report_number']; ?></span>
                                <?php if ($report['report_date'] == $today): ?>
                            ...
                            <td class="text-right"><?php echo formatCurrency($report['cash_balance']); ?></td>
                            <td class="text-right" style="font-weight:600;"><?php echo formatCurrency($report['cumm_total']); ?></td>
                            <td><?php echo date('h:i A', strtotime($report['submitted_at'])); ?></td>
                            <td class="text-center">
                                <div style="display:flex; gap:4px; justify-content:center; flex-wrap:wrap;">
                                    <a href="view.php?id=<?php echo $report['id']; ?>" class="btn btn-secondary btn-sm" title="View">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="edit.php?id=<?php echo $report['id']; ?>" class="btn btn-primary btn-sm" title="Edit">
                ...
                <div style="padding:40px; text-align:center; color:var(--text-light);">
                    ...
                    <p>No morning report records found.</p>
                    <a href="add.php" class="btn btn-primary" style="margin-top:10px;">
                        <i class="fas fa-plus"></i> Add First Morning Report
                    </a>
                </div>
                <?php endif; ?>
            </div>
    ...
    <script>
        ...
        console.log('%c MORNING REPORT DASHBOARD v2.0 ',
