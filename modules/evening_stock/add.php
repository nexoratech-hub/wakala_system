<?php
// ================================================================
// FILE: C:\xampp\htdocs\wakala_system\modules\evening_stock\add.php
// WAKALA FINANCIAL SYSTEM - ADD EVENING STOCK
// WITH NUMBER FORMATTING, ICONS, AND AUTO-CALCULATION
// ================================================================
...
// ============================================================
// CHECK IF EVENING STOCK ALREADY EXISTS FOR TODAY
// ============================================================
$today = date('Y-m-d');
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($cash_balance <= 0 && !$has_value) {
        ...
        try {
            ...
            $stock_number = generateNumber('ES');
            ...
            if ($result) {
                ...
                // Log activity
                logActivity($employee_id, 'Add Evening Stock', 'Evening Stock', $stock_id, '', 'New evening stock added');
                
                $success = 'Evening Stock submitted successfully! Stock Number: ' . $stock_number;
                
                // Redirect after 2 seconds
                echo '<meta http-equiv="refresh" content="2;url=view.php?id=' . $stock_id . '">';
            } else {
...
<head>
    ...
    <title>Add Evening Stock - Wakala</title>
...
<body>
    ...
    <div class="main-wrapper">
        ...
        <main class="main-content">
            ...
            <div class="page-header">
                <div>
                    <h1>
                        <i class="fas fa-plus-circle" style="color:#DC2626;"></i> Add Evening Stock
                        <small>Record evening float and cash balances for <?php echo date('d M Y'); ?></small>
                    </h1>
                </div>
                ...
                <form method="POST" action="" id="eveningStockForm" autocomplete="off">
                    ...
                    <div class="form-actions">
                        <button type="submit" class="btn btn-primary btn-lg" id="submitBtn">
                            <i class="fas fa-save"></i> Submit Evening Stock
                        </button>
                        <a href="index.php" class="btn btn-secondary">
    ...
    <script>
        ...
        // ============================================================
        function resetForm() {
            document.getElementById('eveningStockForm').reset();
            setTimeout(function() {
        ...
        console.log('%c EVENING STOCK - ADD FORM v2.0 ',
