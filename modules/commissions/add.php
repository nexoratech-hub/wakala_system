...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'add_commission') {
    try {
        ...
        $success_message = 'Commission added successfully! Number: ' . $commission_number;
        $show_success = true;
                ...
                <div class="form-section summary-section">
                    ...
                    <div class="summary-grid">
                        <div class="summary-item">
                            ...
                            <span class="summary-value" id="totalCommissionDisplay">TSh 0.00</span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">Other Income:</span>
                            <span class="summary-value" id="otherIncomeDisplay">TSh 0.00</span>
                        </div>
                        <div class="summary-item total">
                            <span class="summary-label">Total Business Income:</span>
                            <span class="summary-value" id="totalIncomeDisplay">TSh 0.00</span>
                        </div>
                    </div>
                </div>
