<?php
// ================================================================
// FILE: modules/salaries/edit.php
// WAKALA FINANCIAL SYSTEM - EDIT SALARY
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'edit_salary') {
    try {
        ...
        // Check if salary already exists for this employee and month (excluding current)
        $check_stmt = $db->prepare("SELECT COUNT(*) FROM employee_salaries WHERE employee_id = ? AND salary_month = ? AND id != ?");
        $check_stmt->execute([$employee_id, $salary_month, $salary_id]);
        ...
        $update_stmt = $db->prepare("UPDATE employee_salaries SET 
            employee_id = ?, branch = ?, branch_id = ?, salary_month = ?, base_salary = ?, 
            bonus = ?, overtime_pay = ?, allowances = ?, total_gross = ?, tax = ?, 
            deductions = ?, net_pay = ?, payment_date = ?, payment_method = ?, 
            transaction_reference = ?, description = ?, status = ?, notes = ? 
            WHERE id = ?");
        ...
        logActivity($user_id, 'Edit Salary', 'Salaries', $salary_id, '', 'Updated salary for: ' . $employee_data['full_name']);
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div class="page-header-left">
                <h2><i class="fas fa-edit"></i> Edit Salary</h2>
                <span class="page-subtitle"><?php echo htmlspecialchars($salary['salary_number']); ?></span>
                <span class="salary-id-badge">ID: #<?php echo $salary_id; ?></span>
            </div>
            <div class="page-header-right">
                <a href="index.php" class="btn btn-back">
                    <i class="fas fa-arrow-left"></i> Back to List
                </a>
                <a href="view.php?id=<?php echo $salary_id; ?>" class="btn btn-view">
                            ...
                            <div class="input-group">
                                ...
                                <select id="employee_id" name="employee_id" class="form-control" required>
                                    ...
                                    <?php foreach ($employees as $emp): ?>
                                        <option value="<?php echo $emp['id']; ?>" <?php echo ($salary['employee_id'] == $emp['id']) ? 'selected' : ''; ?>>
                                            <?php echo htmlspecialchars($emp['full_name']); ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <small>Employee receiving the salary</small>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select id="branch_id" name="branch_id" class="form-control" required>
                                    ...
                                    <?php foreach ($branches as $b): ?>
                                        <option value="<?php echo $b['id']; ?>" <?php echo ($salary['branch_id'] == $b['id']) ? 'selected' : ''; ?>>
                                            <?php echo htmlspecialchars($b['branch_name']); ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <small>Branch where employee works</small>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="month" id="salary_month" name="salary_month" 
                                       value="<?php echo $salary['salary_month']; ?>" 
                                       class="form-control" required>
                            </div>
                            <small>Month for which salary is being paid</small>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="date" id="payment_date" name="payment_date" 
                                       value="<?php echo $salary['payment_date']; ?>" 
                                       class="form-control" required>
                            </div>
                            <small>Date when salary was/will be paid</small>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="base_salary" name="base_salary" 
                                       value="<?php echo number_format($salary['base_salary'] ?? 0, 0, '.', ','); ?>" 
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="bonus" name="bonus" 
                                       value="<?php echo number_format($salary['bonus'] ?? 0, 0, '.', ','); ?>" 
                                       class="form-control money-input" 
                                       placeholder="0.00"
                                       oninput="formatMoneyInput(this); calculateTotals();">
                            </div>
                            <small>Performance bonus or extra payment</small>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="overtime_pay" name="overtime_pay" 
                                       value="<?php echo number_format($salary['overtime_pay'] ?? 0, 0, '.', ','); ?>" 
                                       class="form-control money-input" 
                                       placeholder="0.00"
                                       oninput="formatMoneyInput(this); calculateTotals();">
                            </div>
                            <small>Payment for overtime hours worked</small>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="allowances" name="allowances" 
                                       value="<?php echo number_format($salary['allowances'] ?? 0, 0, '.', ','); ?>" 
                                       class="form-control money-input" 
                                       placeholder="0.00"
                                       oninput="formatMoneyInput(this); calculateTotals();">
                            </div>
                            <small>Housing, transport, or other allowances</small>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="tax" name="tax" 
                                       value="<?php echo number_format($salary['tax'] ?? 0, 0, '.', ','); ?>" 
                                       class="form-control money-input" 
                                       placeholder="0.00"
                                       oninput="formatMoneyInput(this); calculateTotals();">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="deductions" name="deductions" 
                                       value="<?php echo number_format($salary['deductions'] ?? 0, 0, '.', ','); ?>" 
                                       class="form-control money-input" 
                                       placeholder="0.00"
                                       oninput="formatMoneyInput(this); calculateTotals();">
                            </div>
                            <small>Other deductions (loans, advances, etc.)</small>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select id="payment_method" name="payment_method" class="form-control">
                                    <option value="cash" <?php echo ($salary['payment_method'] == 'cash') ? 'selected' : ''; ?>>Cash</option>
                                    <option value="bank_transfer" <?php echo ($salary['payment_method'] == 'bank_transfer') ? 'selected' : ''; ?>>Bank Transfer</option>
                                    <option value="mobile_money" <?php echo ($salary['payment_method'] == 'mobile_money') ? 'selected' : ''; ?>>Mobile Money</option>
                                    <option value="cheque" <?php echo ($salary['payment_method'] == 'cheque') ? 'selected' : ''; ?>>Cheque</option>
                                </select>
                            </div>
                            <small>Method used for salary payment</small>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="transaction_reference" name="transaction_reference" 
                                       value="<?php echo htmlspecialchars($salary['transaction_reference'] ?? ''); ?>" 
                                       class="form-control" placeholder="e.g., TRX-123456">
                            </div>
                            <small>Reference number for the transaction</small>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <select id="status" name="status" class="form-control">
                                    <option value="pending" <?php echo ($salary['status'] == 'pending') ? 'selected' : ''; ?>>Pending</option>
                                    <option value="paid" <?php echo ($salary['status'] == 'paid') ? 'selected' : ''; ?>>Paid</option>
                                    <option value="cancelled" <?php echo ($salary['status'] == 'cancelled') ? 'selected' : ''; ?>>Cancelled</option>
                                    <option value="reversed" <?php echo ($salary['status'] == 'reversed') ? 'selected' : ''; ?>>Reversed</option>
                                </select>
                            </div>
                            <small>Current status of the salary</small>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="description" name="description" 
                                       value="<?php echo htmlspecialchars($salary['description'] ?? ''); ?>" 
                                       class="form-control" placeholder="Brief description">
                            </div>
                            <small>Brief description of the salary</small>
                        </div>
                    </div>
                    ...
                    <div class="form-row">
                        <div class="form-group full-width">
                            ...
                            <div class="input-group">
                                ...
                                <textarea id="notes" name="notes" class="form-control" rows="2" placeholder="Any additional notes..."><?php echo htmlspecialchars($salary['notes'] ?? ''); ?></textarea>
                            </div>
                            <small>Additional notes for this salary record</small>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section summary-section">
                    ...
                    <div class="summary-grid">
                        <div class="summary-item">
                            ...
                            <span class="summary-value" id="grossDisplay">TSh <?php echo number_format($salary['total_gross'] ?? 0, 0, '.', ','); ?></span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">Tax:</span>
                            <span class="summary-value" id="taxDisplay">TSh <?php echo number_format($salary['tax'] ?? 0, 0, '.', ','); ?></span>
                        </div>
                        <div class="summary-item">
                            <span class="summary-label">Deductions:</span>
                            <span class="summary-value" id="deductionsDisplay">TSh <?php echo number_format($salary['deductions'] ?? 0, 0, '.', ','); ?></span>
                        </div>
                        <div class="summary-item total">
                            <span class="summary-label">Net Pay:</span>
                            <span class="summary-value" id="netPayDisplay">TSh <?php echo number_format($salary['net_pay'] ?? 0, 0, '.', ','); ?></span>
                        </div>
                    </div>
                    
                    <div class="salary-info">
                        <div class="info-row">
                            <span class="info-label"><i class="fas fa-id-card"></i> Salary Number:</span>
                            <span class="info-value"><?php echo htmlspecialchars($salary['salary_number']); ?></span>
                        </div>
                        <div class="info-row">
                            <span class="info-label"><i class="fas fa-clock"></i> Created:</span>
                            <span class="info-value"><?php echo date('d M Y H:i:s', strtotime($salary['created_at'])); ?></span>
                        </div>
                        <div class="info-row">
                            <span class="info-label"><i class="fas fa-clock"></i> Last Updated:</span>
                            <span class="info-value"><?php echo date('d M Y H:i:s', strtotime($salary['updated_at'])); ?></span>
                        </div>
                    </div>
                </div>
