<?php
// ================================================================
// FILE: modules/transfers/view.php
// WAKALA FINANCIAL SYSTEM - ADMIN VIEW TRANSFER
    ...
    <div class="main-content">
        ...
        <div class="branch-indicator">
            ...
            <div class="branch-indicator-right">
                <a href="index.php?branch_id=<?php echo $transfer['branch_id']; ?>" class="btn-back-card">
        ...
        <div class="page-header">
            ...
            <div class="header-right">
                <a href="edit.php?id=<?php echo $id; ?>" class="btn btn-edit-transfer">
                    <i class="fas fa-edit"></i> Edit
                </a>
                <button onclick="deleteTransfer(<?php echo $id; ?>, '<?php echo addslashes($transfer['transfer_number']); ?>')" 
                        class="btn btn-delete-transfer">
        ...
        <div class="details-grid">
            ...
            <div class="detail-card">
                ...
                <div class="detail-card-body">
                    ...
                    <div class="info-row">
                        <span class="info-label"><i class="fas fa-edit"></i> Last Updated</span>
                        <span class="info-value"><?php echo date('d M Y H:i:s', strtotime($transfer['updated_at'])); ?></span>
                    </div>
                    <?php endif; ?>
        ...
        <!-- ============================================================
        ACTION BUTTONS - BACK + EDIT + PRINT + DELETE
        ============================================================ -->
        <div class="actions-card">
            <a href="index.php?branch_id=<?php echo $transfer['branch_id']; ?>" class="btn btn-back-large">
                <i class="fas fa-arrow-left"></i>
                <span>Back to Transfers</span>
            </a>
            ...
            <!-- ✅ PRINT RECEIPT - LINK TO RECEIPT PAGE (ADMIN) -->
            <a href="receipt.php?id=<?php echo $id; ?>" class="btn btn-print-large">
...
.btn-back-large, .btn-edit-large, .btn-print-large, .btn-delete-large {
    padding: 12px 22px;
...
@media (max-width: 768px) {
    ...
    .header-right .btn-edit-transfer,
    .header-right .btn-delete-transfer {
        flex: 1;
        justify-content: center;
    }
    ...
    .tmc-icon { width: 72px; height: 72px; font-size: 32px; }
    ...
    .actions-card .btn-edit-large,
    .actions-card .btn-print-large,
    .actions-card .btn-delete-large { width: 100%; }
}
...
function deleteTransfer(id, number) {
    if (confirm('Delete transfer "' + number + '"?\n\n⚠️ This will also reverse the float and cash changes.\n\nThis action cannot be undone.')) {
