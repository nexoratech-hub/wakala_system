<?php
// ================================================================
// FILE: modules/transfers/receipt_employee.php
// WAKALA FINANCIAL SYSTEM - TRANSFER RECEIPT (Employee)
// GREEN THEME + LOGO + Print-friendly
// ================================================================
    ...
    <style>
        ...
        * {
        ...
        .amount-value {
            ...
            text-shadow: 0 2px 8px rgba(5, 150, 105, 0.15);
        }
...
<div class="receipt-wrapper">
    ...
    <div class="action-bar">
        <a href="view_employee.php?id=<?php echo $id; ?>" class="btn-action btn-back">
                ...
                <div class="header-left">
                    <div class="logo-wrapper">
                        <img src="<?php echo htmlspecialchars($logo_path); ?>" 
                             ...
                             onerror="this.style.display='none'; this.parentElement.innerHTML='<i class=\'fas fa-building\' style=\'font-size:36px;color:#059669;\'></i>';">
                    </div>
        ...
        <div class="receipt-body">
            ...
            <div class="info-section">
                ...
                <div class="financial-section">
                    ...
                    <div class="financial-row">
                        <span class="financial-label" style="font-weight: 900; color: #047857; font-size: 14px;">
